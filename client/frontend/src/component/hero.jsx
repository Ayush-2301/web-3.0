...
const Hero = () => {
  ...
  return (
    <div className='container mx-auto font-poppins flex flex-row justify-evenly m-10 '>
      <div className='flex flex-col text-6xl items-center text-gradient mt-5'>
        <p className='inline w-[340px] font-semibold capitalize'>Send Transaction Through the Blockchain</p>
       {!currentAccount &&  (<button onClick={connectWallet} className=' bg-[rgb(116,32,96)] text-gray-300 font-medium p-2 px-4 m-3 w-full text-2xl rounded-full'>Connect Wallet</button>)}
      </div>
      <div className='m-5'>
        <div className='w-[400px] h-[200px] rounded-xl eth-card p-2 text-white flex flex-col justify-between'>
          ...
          <p className='m-2 ml-1'>Address: {shortenAddress(currentAccount)}</p>
        </div>
